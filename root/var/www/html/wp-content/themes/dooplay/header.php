...
<meta name="viewport" content="width=device-width, initial-scale=0.64, shrink-to-fit=no">
...
function navbar() {
  var x = document.getElementById('arch-menu');
...
<script>
function searchbar() {
  var x = document.getElementById('form-search-resp');
  if (x.style.display === 'block') {
    x.style.display = 'none';
  } else {
    x.style.display = 'block';
...
<div class="fixheadresp">
	<header id="header" class="responsive">
		<div class="nav" onclick="navbar()"><a class="aresp nav-resp"></a></div>
		<div class="search" onclick="searchbar()"><a class="aresp search-resp"></a></div>
		<div class="logo">
            <a href="<?php echo esc_url( home_url() ); ?>/"><?php echo $logo; ?></a>
        </div>
	</header>
