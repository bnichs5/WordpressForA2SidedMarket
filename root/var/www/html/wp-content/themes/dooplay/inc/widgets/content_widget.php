...
class DT_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$tipo   = $instance['dt_tipo'] == 'movies_shows' ? array('movies','tvshows') : $instance['dt_tipo'];
	...
	function update( $new_instance, $old_instance ) {
		...
		$instance['dt_tipo']   = doo_isset($new_instance,'dt_tipo');
		return $instance;
	}
	function form( $instance ) {
		...
		<p>
			...
			<select id="<?php echo $this->get_field_id('dt_tipo'); ?>" name="<?php echo $this->get_field_name('dt_tipo'); ?>" style="width:100%;">
				...
				<option <?php if ('movies_shows' == $instance['dt_tipo'] ) echo 'selected="selected"'; ?> value="movies_shows"><?php _d('Movies and Shows'); ?></option>
            </select>
		</p>
		<p>
