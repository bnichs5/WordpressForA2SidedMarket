  ...
  <form action="#" data-callback="<?php echo isset($_REQUEST['callback']) ? $_REQUEST['callback'] : ''; ?>">
    ...
    <div class="wrap">
      <div class="outofthebox-header">
        ...
        <div class="outofthebox-title"><?php _e('Shortcode Builder', 'wpcloudplugins'); ?></div>

      </div>
      <div id="" class="outofthebox-panel outofthebox-panel-left">
        <div class="outofthebox-nav-header"><?php _e('Shortcode Options', 'wpcloudplugins'); ?></div>
      ...
      <div class="outofthebox-panel outofthebox-panel-right">
        ...
        <div id="settings_general" class="outofthebox-tab-panel current">
          ...
          <div class="outofthebox-option-title"><?php _e('Plugin Mode', 'wpcloudplugins'); ?></div>
          <div class="outofthebox-option-description"><?php _e('Select how you want to display your content', 'wpcloudplugins'); ?>:</div>
          <div class="outofthebox-option-radio">
            ...
            <label for="files" class="outofthebox-option-radio-label"><?php _e('File Browser', 'wpcloudplugins'); ?></label>
          </div>
          <div class="outofthebox-option-radio">
            <input type="radio" id="upload" name="mode" <?php echo ('upload' === $mode) ? 'checked="checked"' : ''; ?> value="upload" class="mode" />
            <label for="upload" class="outofthebox-option-radio-label"><?php _e('Upload Box', 'wpcloudplugins'); ?></label>
          </div>
          <?php if (false === $uploadbox_only) { ?>
            <div class="outofthebox-option-radio">
              ...
              <label for="gallery" class="outofthebox-option-radio-label"><?php _e('Photo Gallery', 'wpcloudplugins'); ?> <small>(Images only)</small></label>
            </div>
            <div class="outofthebox-option-radio">
              <input type="radio" id="audio" name="mode" <?php echo ('audio' === $mode) ? 'checked="checked"' : ''; ?> value="audio" class="mode" />
              <label for="audio" class="outofthebox-option-radio-label"><?php _e('Audio Player', 'wpcloudplugins'); ?> <small>(MP3, M4A, OGG, OGA, WAV)</small></label>
            </div>
            <div class="outofthebox-option-radio">
              <input type="radio" id="video" name="mode" <?php echo ('video' === $mode) ? 'checked="checked"' : ''; ?> value="video" class="mode" />
              <label for="video" class="outofthebox-option-radio-label"><?php _e('Video Player', 'wpcloudplugins'); ?> <small>(MP4, M4V, OGG, OGV, WEBM, WEBMV)</small></label>
            </div>
            <div class="outofthebox-option-radio">
              <input type="radio" id="search" name="mode" <?php echo ('search' === $mode) ? 'checked="checked"' : ''; ?> value="search" class="mode" />
              <label for="search" class="outofthebox-option-radio-label"><?php _e('Search Box', 'wpcloudplugins'); ?></label>
            </div>
          <?php
          } else {
              ?>
        ...
        <div id="settings_folders" class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('Folders', 'wpcloudplugins'); ?></div>

          <div class="forfilebrowser forgallery">
            <div class="outofthebox-option-title"><?php _e('Use single cloud account', 'wpcloudplugins'); ?>
            ...
            <div class="outofthebox-option-description"><?php _e('Use a folder from one of the linked account. Disabling this option allows your users to navigate through the folders of all your linked accounts', 'wpcloudplugins'); ?>
            </div>
          </div>

          <div class="option-singleaccount <?php echo (isset($_REQUEST['singleaccount']) && '0' === $_REQUEST['singleaccount']) ? 'hidden' : ''; ?>">
            <div class="outofthebox-option-title"><?php _e('Select start Folder', 'wpcloudplugins'); ?></div>
            <div class="outofthebox-option-description"><?php _e('Select which folder should be used as starting point, or in case the Smart Client Area is enabled should be used for the Private Folders', 'wpcloudplugins'); ?>. <?php _e('Users will not be able to navigate outside this folder', 'wpcloudplugins'); ?>.</div>
            ...
            <br />
            <div class="outofthebox-tab-panel-header"><?php _e('Smart Client Area', 'wpcloudplugins'); ?></div>

            <div class="outofthebox-option-title"><?php _e('Use Private Folders', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description">
              <?php echo sprintf(__('The plugin can easily and securily share documents on your %s with your users/clients', 'wpcloudplugins'), 'wpcloudplugins'); ?>.
            ...
            <div class="outofthebox-suboptions option-userfolders forfilebrowser foruploadbox forgallery <?php echo (isset($_REQUEST['userfolders'])) ? '' : 'hidden'; ?>">
              ...
              <div class="outofthebox-option-title"><?php _e('Mode', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e('Do you want to link your users manually to their Private Folder or should the plugin handle this automatically for you?', 'wpcloudplugins'); ?>.</div>
              ...
              <div class="outofthebox-option-radio">
                ...
                <label for="userfolders_method_manual" class="outofthebox-option-radio-label"><?php echo sprintf(__('I will link the users manually via %sthis page%s', 'wpcloudplugins'), '<a href="'.admin_url('admin.php?page=OutoftheBox_settings_linkusers').'" target="_blank">', '</a>'); ?></label>
              </div>
              <div class="outofthebox-option-radio">
                ...
                <label for="userfolders_method_auto" class="outofthebox-option-radio-label"><?php _e('Let the plugin automatically manage the Private Folders for me in the folder I have selected above', 'wpcloudplugins'); ?></label>
              </div>

              <div class="option-userfolders_auto">
                <div class="outofthebox-option-title"><?php _e('Template Folder', 'wpcloudplugins'); ?>
                  <div class="outofthebox-onoffswitch">
                ...
                <div class="outofthebox-option-title"><?php _e('Quota', 'wpcloudplugins'); ?></div>
                <div class="outofthebox-option-description"><?php _e('Set maximum size of the User Folder (e.g. 10M, 100M, 1G). When the Upload function is enabled, the user will not be able to upload when the limit is reached', 'wpcloudplugins'); ?>. <?php _e('Leave this field empty or set it to -1 for unlimited disk space', 'wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_layout" class="outofthebox-tab-panel">
          ...
          <div class="outofthebox-option-title"><?php _e('Plugin container width', 'wpcloudplugins'); ?></div>
          <div class="outofthebox-option-description"><?php _e('Set max width for the plugin container', 'wpcloudplugins'); ?>. <?php _e("You can use pixels or percentages, eg '360px', '480px', '70%'", 'wpcloudplugins'); ?>. <?php echo __('Leave empty for default value', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="forfilebrowser forgallery forsearch foruploadbox">
            <div class="outofthebox-option-title"><?php _e('Plugin container height', 'wpcloudplugins'); ?></div>
            <div class="outofthebox-option-description"><?php _e('Set max height for the plugin container', 'wpcloudplugins'); ?>. <?php _e("You can use pixels or percentages, eg '360px', '480px', '70%'", 'wpcloudplugins'); ?>. <?php _e('Leave empty for default value', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="outofthebox-option-title"><?php _e('Custom CSS Class', 'wpcloudplugins'); ?></div>
          <div class="outofthebox-option-description"><?php _e('Add your own custom classes to the plugin container. Multiple classes can be added seperated by a whitespace', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="foraudio forvideo">
            ...
            <div class="outofthebox-option-title"><?php _e('Media Player', 'wpcloudplugins'); ?></div>
            <div>
            ...
            <div class="outofthebox-option-title"><?php _e('Mediaplayer Buttons', 'wpcloudplugins'); ?></div>
            <div class="outofthebox-option-description"><?php _e('Set which buttons (if supported) should be visible in the mediaplayer', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="outofthebox-option-title"><?php _e('Show Playlist', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-suboptions playlist-options <?php echo (isset($_REQUEST['hideplaylist']) && '1' === $_REQUEST['hideplaylist']) ? 'hidden' : ''; ?>">
              <div class="outofthebox-option-title"><?php _e('Playlist open on start', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="forvideo">
                <div class="outofthebox-option-title"><?php _e('Playlist opens on top of player', 'wpcloudplugins'); ?>
                  <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-title"><?php _e('Display thumbnails', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Show thumbnails of your files in the Playlist', 'wpcloudplugins'); ?>. <?php _e('The plugin show the thumbnail provided by the cloud server or you can use your own one', 'wpcloudplugins'); ?>. <?php _e('If you want to use your own thumbnail, add a *.png or *.jpg file with the same name in the same folder. You can also add a cover with the name of the folder to show the cover for all files', 'wpcloudplugins'); ?>. <?php _e('If no cover is available, a placeholder will be used', 'wpcloudplugins'); ?>.</div>

              <div class="outofthebox-option-title"><?php _e('Show last modified date', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-title"><?php _e('Download Button', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-title"><?php _e('Purchase Button', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="option webshop-options <?php echo (isset($_REQUEST['linktoshop'])) ? '' : 'hidden'; ?>">
                <div class="outofthebox-option-title"><?php _e('Link to webshop', 'wpcloudplugins'); ?></div>
          ...
          <div class="forfilebrowser forsearch">
            <div class="outofthebox-option-title"><?php _e('File Browser view', 'wpcloudplugins'); ?></div>
            <?php
            ...
            <div class="outofthebox-option-radio">
              ...
              <label for="file_layout_grid" class="outofthebox-option-radio-label"><?php _e('Grid/Thumbnail View', 'wpcloudplugins'); ?></label>
            </div>
            <div class="outofthebox-option-radio">
              <input type="radio" id="file_layout_list" name="OutoftheBox_file_layout" <?php echo ('list' === $filelayout) ? 'checked="checked"' : ''; ?> value="list" />
              <label for="file_layout_list" class="outofthebox-option-radio-label"><?php _e('List View', 'wpcloudplugins'); ?></label>
            </div>
          </div>

          <div class=" forfilebrowser forgallery">
            <div class="outofthebox-option-title"><?php _e('Show header', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-suboptions header-options <?php echo (isset($_REQUEST['showbreadcrumb']) && '0' === $_REQUEST['showbreadcrumb']) ? 'hidden' : ''; ?>">
              <div class="outofthebox-option-title"><?php _e('Show refresh button', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Add a refresh button in the header so users can refresh the file list and pull changes', 'wpcloudplugins'); ?></div>

              <div class="outofthebox-option-title"><?php _e('Breadcrumb text for top folder', 'wpcloudplugins'); ?></div>
              <input type="text" name="OutoftheBox_roottext" id="OutoftheBox_roottext" placeholder="<?php _e('Start', 'wpcloudplugins'); ?>" value="<?php echo (isset($_REQUEST['roottext'])) ? $_REQUEST['roottext'] : ''; ?>" />
            </div>
          </div>
          ...
          <div class=" forfilebrowser forsearch">
            <div class="option forfilebrowser forsearch forlistonly">
              ...
              <div class="outofthebox-suboptions">
                <div class="option-filesize">
                  <div class="outofthebox-option-title"><?php _e('Show file size', 'wpcloudplugins'); ?>
                    <div class="outofthebox-onoffswitch">
                  ...
                  <div class="outofthebox-option-description"><?php _e('Display or Hide column with file sizes in List view', 'wpcloudplugins'); ?></div>
                </div>
                ...
                <div class="option-filedate">
                  ...
                  <div class="outofthebox-option-description"><?php _e('Display or Hide column with last modified date in List view', 'wpcloudplugins'); ?></div>
                </div>
              </div>
            </div>

            <div class="option forfilebrowser forgallery forsearch">
              <div class="outofthebox-option-title"><?php _e('Show file extension', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Display or Hide the file extensions', 'wpcloudplugins'); ?></div>

              <div class="outofthebox-option-title"><?php _e('Show files', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Display or Hide files', 'wpcloudplugins'); ?></div>
            </div>

            <div class="outofthebox-option-title"><?php _e('Show folders', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Display or Hide child folders', 'wpcloudplugins'); ?></div>
          </div>

          <div class="option forgallery">
            <div class="outofthebox-option-title"><?php _e('Show file names', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Display or Hide the file names in the gallery', 'wpcloudplugins'); ?></div>

            <!-- Descriptions not implemented in Dropbox 
            <div class="outofthebox-option-title"><?php _e('Show descriptions on top', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Display directly on top of the thumbnail', 'wpcloudplugins'); ?>. <?php _e('When disabled, the description can be shown by hovering over the image', 'wpcloudplugins'); ?>.</div>
            -->

            <div class="outofthebox-option-title"><?php _e('Gallery row height', 'wpcloudplugins'); ?></div>
            <div class="outofthebox-option-description"><?php _e('The ideal height you want your grid rows to be', 'wpcloudplugins'); ?>. <?php _e("It won't set it exactly to this as plugin adjusts the row height to get the correct width", 'wpcloudplugins'); ?>. <?php _e('Leave empty for default value', 'wpcloudplugins'); ?> (250px).</div>
            ...
            <div class="outofthebox-option-title"><?php _e('Number of images lazy loaded', 'wpcloudplugins'); ?></div>
            <div class="outofthebox-option-description"><?php _e('Number of images to be loaded each time', 'wpcloudplugins'); ?>. <?php _e('Set to 0 to load all images at once', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="outofthebox-option-title"><?php _e('Show Folder Thumbnails in Gallery', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Do you want to show thumbnails for the Folders in the gallery mode?', 'wpcloudplugins'); ?> <?php _e('Please note, when enabled the loading performance can drop proportional to the number of folders present in the Gallery', 'wpcloudplugins'); ?>.</div>

            <div class="outofthebox-option-title"><?php _e('Crop your thumbnails', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-title"><?php _e('Slideshow', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="slideshow-options">
              <div class="outofthebox-option-description"><?php _e('Enable or disable the Slideshow mode in the Inline Preview ', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-title"><?php _e('Delay between cycles (ms)', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e('Delay between cycles in milliseconds, the default is 5000', 'wpcloudplugins'); ?>.</div>
        ...
        <div id="settings_sorting" class="outofthebox-tab-panel">
          ...
          <div class="outofthebox-tab-panel-header"><?php _e('Sorting', 'wpcloudplugins'); ?></div>

          <div class="outofthebox-option-title"><?php _e('Sort field', 'wpcloudplugins'); ?></div>
          <?php
          ...
          <div class="outofthebox-option-radio">
            ...
            <label for="name" class="outofthebox-option-radio-label"><?php _e('Name', 'wpcloudplugins'); ?></label>
          </div>
          <div class="outofthebox-option-radio">
            <input type="radio" id="size" name="sort_field" <?php echo ('size' === $sortfield) ? 'checked="checked"' : ''; ?> value="size" />
            <label for="size" class="outofthebox-option-radio-label"><?php _e('Size', 'wpcloudplugins'); ?></label>
          </div>
          <div class="outofthebox-option-radio">
            <input type="radio" id="modified" name="sort_field" <?php echo ('modified' === $sortfield) ? 'checked="checked"' : ''; ?> value="modified" />
            <label for="modified" class="outofthebox-option-radio-label"><?php _e('Last modified date', 'wpcloudplugins'); ?></label>
          </div>
          <div class="outofthebox-option-radio">
            <input type="radio" id="shuffle" name="sort_field" <?php echo ('shuffle' === $sortfield) ? 'checked="checked"' : ''; ?> value="shuffle" />
            <label for="shuffle" class="outofthebox-option-radio-label"><?php _e('Shuffle/Random', 'wpcloudplugins'); ?></label>
          </div>

          <div class="option-sort-field">
            <div class="outofthebox-option-title"><?php _e('Sort order:', 'wpcloudplugins'); ?></div>
            ...
            <div class="outofthebox-option-radio">
              ...
              <label for="asc" class="outofthebox-option-radio-label"><?php _e('Ascending', 'wpcloudplugins'); ?></label>
            </div>
            <div class="outofthebox-option-radio">
              <input type="radio" id="desc" name="sort_order" <?php echo ('desc' === $sortorder) ? 'checked="checked"' : ''; ?> value="desc" />
              <label for="desc" class="outofthebox-option-radio-label"><?php _e('Descending', 'wpcloudplugins'); ?></label>
            </div>
          </div>
        </div>
        <!-- End Sorting Tab -->
        ...
        <div id="settings_advanced" class="outofthebox-tab-panel">
          ...
          <div class="forfilebrowser forgallery forsearch">
            <div class="outofthebox-option-title"><?php _e('Allow Preview', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-suboptions preview-options <?php echo (isset($_REQUEST['forcedownload']) && '1' === $_REQUEST['forcedownload']) ? 'hidden' : ''; ?>">
              <div class="outofthebox-option-title"><?php _e('Inline Preview', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Open preview inside a lightbox or open in a new window', 'wpcloudplugins'); ?></div>
              ...
              <div class="outofthebox-suboptions preview-options-inline <?php echo (isset($_REQUEST['previewinline']) && '0' === $_REQUEST['previewinline']) ? 'hidden' : ''; ?>">
                ...
                <div class="outofthebox-option-title"><?php _e('Enable Google pop out Button', 'wpcloudplugins'); ?>
                  <div class="outofthebox-onoffswitch">
                ...
                <div class="outofthebox-option-description"><?php _e('Disables the Google Pop Out button which is visible in the inline preview for a couple of file formats', 'wpcloudplugins'); ?>. </div>

                <div class="outofthebox-option-title">Lightbox <?php _e('Navigation', 'wpcloudplugins'); ?>
                  <div class="outofthebox-onoffswitch">
                ...
                <div class="outofthebox-option-description"><?php _e('Navigate through your documents in the inline preview. Disable when each document should be shown individually without navigation arrows', 'wpcloudplugins'); ?>. </div>

              </div>
            </div>

            <div class="outofthebox-option-title"><?php _e('Allow Searching', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('The search function allows your users to find files by filename and content (when files are indexed)', 'wpcloudplugins'); ?></div>
          </div>
          ...
          <div class="option forfilebrowser foruploadbox forgallery forsearch">
            <div class="outofthebox-suboptions option search-options <?php echo (isset($_REQUEST['search']) && '1' === $_REQUEST['search']) ? '' : 'hidden'; ?>">
              <div class="outofthebox-option-title"><?php _e('Perform Full-Text search', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Business Accounts only', 'wpcloudplugins'); ?>. </div>

              <div class="outofthebox-option-title"><?php _e('Initial Search Term', 'wpcloudplugins'); ?></div>
              <div class="outofthebox-option-description"><?php _e('Add search terms if you want to start a search when the shortcode is rendered. Please note that this only affects the initial render. If you want to only show specific files, you can use the Exclusions tab', 'wpcloudplugins'); ?>.</div>
          ...
          <div class=" forfilebrowser forsearch forgallery">
            ...
            if (class_exists('ZipArchive')) {
                ?>
              <div class="outofthebox-option-title"><?php _e('Allow ZIP Download', 'wpcloudplugins'); ?>
                <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Allow users to download multiple files at once', 'wpcloudplugins'); ?></div>
            <?php
            } ?>
          </div>
          ...
          <div class="foraudio forvideo">
            <div class="outofthebox-option-title"><?php _e('Auto Play', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
              ...
              <div class="outofthebox-option-description"><?php _e('Autoplay is generally not recommended as it is seen as a negative user experience. It is also disabled in many browsers', 'wpcloudplugins'); ?>.</div>
            </div>
          </div>

          <div class="forvideo">
            <div class="outofthebox-option-title"><?php _e('Enable Video Advertisements', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
        ...
        <div id="settings_exclusions" class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('Exclusions', 'wpcloudplugins'); ?></div>

          <div class="showfiles-options">
            <div class="outofthebox-option-title"><?php _e('Amount of files', 'wpcloudplugins'); ?>
            </div>
            <div class="outofthebox-option-description"><?php _e('Number of files to show', 'wpcloudplugins'); ?>. <?php _e('Can be used for instance to only show the last 5 updated documents', 'wpcloudplugins'); ?>. <?php _e('Leave this field empty or set it to -1 for no limit', 'wpcloudplugins'); ?></div>
          ...
          <div class="outofthebox-option-title"><?php _e('Only show files with those extensions', 'wpcloudplugins'); ?>:</div>
          <div class="outofthebox-option-description"><?php echo __('Add extensions separated with | e.g. (jpg|png|gif)', 'wpcloudplugins').'. '.__('Leave empty to show all files', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="outofthebox-option-title"><?php _e('Only show the following files or folders', 'wpcloudplugins'); ?>:</div>
          <div class="outofthebox-option-description"><?php echo __('Add files or folders by name or ID separated with | e.g. (file1.jpg|long folder name)', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="outofthebox-option-title"><?php _e('Hide the following files or folders', 'wpcloudplugins'); ?>:</div>
          <div class="outofthebox-option-description"><?php echo __('Add files or folders by name or ID separated with | e.g. (file1.jpg|long folder name)', 'wpcloudplugins'); ?>.</div>
          ...
          <div class="outofthebox-option-title"><?php _e('Show system files', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
          ...
          <div class="outofthebox-option-description"><?php _e('Display hidden system (dot) files (e.g. .DS_store, .config)', 'wpcloudplugins'); ?></div>
        </div>
        <!-- End Exclusions Tab -->
        ...
        <div id="settings_upload" class="outofthebox-tab-panel">
          ...
          <div class="outofthebox-tab-panel-header"><?php _e('Upload Box', 'wpcloudplugins'); ?></div>

          <div class="outofthebox-option-title"><?php _e('Allow Upload', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
          ...
          <div class="outofthebox-option-description"><?php _e('Allow users to upload files', 'wpcloudplugins'); ?>. <?php echo sprintf(__('You can select which Users Roles should be able to upload via %s', 'wpcloudplugins'), '<a href="#" onclick="jQuery(\'li[data-tab=settings_permissions]\').trigger(\'click\')">'.__('User Permissions', 'wpcloudplugins').'</a>'); ?>.</div>
          ...
          <div class="outofthebox-suboption upload-options <?php echo (isset($_REQUEST['upload']) && '1' === $_REQUEST['upload'] && in_array($mode, ['files', 'upload', 'gallery'])) ? '' : 'hidden'; ?>">
            ...
            <div class="outofthebox-option-title"><?php _e('Allow folder upload', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-title"><?php _e('Automatically starting upload', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Overwrite already existing files or auto-rename the new uploaded files', 'wpcloudplugins'); ?>. </div>

            <div class="outofthebox-option-title"><?php _e('Restrict file extensions', 'wpcloudplugins'); ?></div>
            <div class="outofthebox-option-description"><?php echo __('Add extensions separated with | e.g. (jpg|png|gif)', 'wpcloudplugins').' '.__('Leave empty for no restriction', 'outofthebox', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="outofthebox-option-title"><?php _e('Max uploads per session', 'wpcloudplugins'); ?></div>
            <div class="outofthebox-option-description"><?php echo __('Number of maximum uploads per upload session', 'wpcloudplugins').' '.__('Leave empty for no restriction', 'wpcloudplugins'); ?>.</div>
            ...
            <div class="outofthebox-option-title"><?php _e('Minimum file size', 'wpcloudplugins'); ?></div>
            <?php
            ...
            <div class="outofthebox-option-description"><?php _e('Min filesize (e.g. 1 MB) for uploading', 'wpcloudplugins'); ?>. <?php echo __('Leave empty for no restriction', 'wpcloudplugins'); ?>.</div>
            <input type="text" name="OutoftheBox_minfilesize" id="OutoftheBox_minfilesize" value="<?php echo $min_size_value; ?>" />

            <div class="outofthebox-option-title"><?php _e('Maximum file size', 'wpcloudplugins'); ?></div>
            <?php
            ...
            <div class="outofthebox-option-description"><?php _e('Max filesize for uploading', 'wpcloudplugins'); ?>. <?php _e('Leave empty for server maximum', 'wpcloudplugins'); ?> (<?php echo $max_size_string; ?>).</div>
        ...
        <div id="settings_notifications" class="outofthebox-tab-panel">
          ...
          <div class="outofthebox-option-title"><?php _e('Download email notification', 'wpcloudplugins'); ?>
            <div class="outofthebox-onoffswitch">
          ...
          <div class="option upload-options">
            <div class="outofthebox-option-title"><?php _e('Upload email notification', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
          ...
          <div class="option delete-options">
            <div class="outofthebox-option-title"><?php _e('Delete email notification', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
        ...
        <div id="settings_manipulation" class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('File Manipulation', 'wpcloudplugins'); ?></div>

          <div class="option forfilebrowser forgallery">

            <div class="outofthebox-option-title"><?php _e('Allow Direct Links', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Allow users to generate a link to a folder/file on your website. Only users with access to the shortcode and content will be able to open the link', 'wpcloudplugins'); ?></div>

            <div class="outofthebox-option-title"><?php _e('Allow Sharing', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-description"><?php _e('Allow users to generate permanent shared links to the files', 'wpcloudplugins'); ?></div>

            <div class="outofthebox-option-title"><?php _e('Rename files and folders', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-title"><?php _e('Move files and folders', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-title"><?php _e('Copy files and folders', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
            ...
            <div class="outofthebox-option-title"><?php _e('Delete files and folders', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
          ...
          <div class="option forfilebrowser">
            <div class="outofthebox-option-title" style="display:none!important;"><?php _e('Create new documents', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
          ...
          <div class="option forfilebrowser forgallery">
            <div class="outofthebox-option-title"><?php _e('Create new folders', 'wpcloudplugins'); ?>
              <div class="outofthebox-onoffswitch">
        ...
        <div id="settings_permissions" class="outofthebox-tab-panel">
          <div class="outofthebox-tab-panel-header"><?php _e('User Permissions', 'wpcloudplugins'); ?></div>
          ...
          <div class="outofthebox-accordion">
            ...
            <div class="option forfilebrowser forsearch outofthebox-permissions-box preview-options">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can preview?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch deeplink-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can link to content?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch sharing-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can share content?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch rename-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can rename files?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch rename-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can rename folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch move-options">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can move files and folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch copy-options">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can copy files?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch copy-options">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can copy folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch delete-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can delete files?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery forsearch delete-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can delete folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser createdocument-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can create new documents?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
            ...
            <div class="option outofthebox-permissions-box forfilebrowser forgallery addfolder-options ">
              <div class="outofthebox-accordion-title outofthebox-option-title"><?php _e('Who can create new folders?', 'wpcloudplugins'); ?></div>
              <div>
                <?php
