(function ($) {
    ...
    $('#wpforms-builder').on('click', '.outofthebox.open-shortcode-builder', function () {
        ...
        tb_show("Build Shortcode for Form", ajaxurl + '?action=outofthebox-getpopup&' + query + '&type=shortcodebuilder&asuploadbox=1&callback=wpcp_oftb_wpforms_add_content&TB_iframe=true&height=600&width=800');
    ...
    if (typeof window.wpcp_oftb_wpforms_add_content === 'undefined') {
        window.wpcp_oftb_wpforms_add_content = function (data) {
